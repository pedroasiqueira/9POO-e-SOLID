...
interface DbCharacter extends Characterr {
  id: number;
}
...
interface IModel {
  create(character: Characterr): Promise<DbCharacter>;
  update(id: number, character: Characterr): Promise<DbCharacter>;
...
class LocalDbModel implements IModel {
  ...
  async create(character: Characterr) {
  ...
  async update(id: number, character: Characterr) {
